...
%%%%%
  ...
  %   \begin{center}
  %     \vspace{-1in}
  %     \includegraphics[page=1]{../graphics/test-parent.pdf}  
  %   \end{center}
  ...
  %   \begin{center}
  %     \vspace{-2in}
  %     \includegraphics[page=2]{../graphics/test-parent.pdf} 
  %   \end{center}

  %   \vspace{-2in}

  %   \begin{center}
  %     \includegraphics[page=3]{../graphics/test-parent.pdf}  
  %   \end{center}

  % \begin{center}
  %     \includegraphics[page=4]{../graphics/test-parent.pdf} 
  %   \end{center}
