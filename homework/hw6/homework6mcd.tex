...
\lstinputlisting[language=R, caption=R Code for 1A, firstline=18, lastline=52, firstnumber=1]{cs571-hw6.r}

The following code runs the burn-in and sampling iterations: 
\lstinputlisting[language=R, caption=R Code for 1A, firstline=54, lastline=95, firstnumber=37]{cs571-hw6.r}
