...
In the model, we have three parameters of interest: $\mu_1, \mu_2$, and $\mu_{12}$, where $\mu_{12}=\mathbb{E}[\psi_{12}(x_1 x_2)]$. We have the constraint $0 \leq \mu_{12} \leq \mu_1, \mu_2$. We limit acceptable values to those within the portion of the simplex that satisfies this constraint, visualized in Figure \ref{mu}. 
...
If we take a slice of this convex polytope at $\mu_1=\mu_2$, it is a triangle. 
% add triangle drawing and explain mu_1^2 = mu_{12}
